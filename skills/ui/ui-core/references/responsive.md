...
- A "squeezed desktop" (same layout, everything just smaller and
  cramped) at any tier fails verify — see Phase 5.
...
- 44×44px minimum hit area (per verify.md), including padding — a 24px
...
- Tables: desktop keeps the table. Mobile becomes stacked cards (label:
  ...
  unless the data is genuinely tabular-only (e.g. a spreadsheet-like
  tool).
