...
- Max 4-5 avatars visible before overflow. Show "+N" for the rest.
- Overlap: 25-33% overlap (avatar width minus gap). Gap should be
  2-4px.
...
- Placement: bottom-right of the avatar, offset by 2-4px. Don't center
  it — it overlaps the avatar content.
...
- Square: use for teams, projects, or organizations. Radius 4-8px,
